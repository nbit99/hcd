...
import (
	...
	"github.com/nbit99/hcd/sampleconfig"
...
type config struct {
	...
	RPCListeners         []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 14009, testnet: 12009)"`
