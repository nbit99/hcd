...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/nbit99/hcd/hcutil/coinset)
...
```bash
$ go get -u github.com/nbit99/hcd/hcutil/coinset
```
