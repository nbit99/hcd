...
// Peer provides a basic concurrent safe hcd peer for handling hcd
...
// newPeerBase returns a new base hcd peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound hcd peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound hcd peer.
