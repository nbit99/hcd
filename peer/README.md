...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/nbit99/hcd/peer)
...
```bash
$ go get -u github.com/nbit99/hcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/nbit99/hcd/peer#example-package--NewOutboundPeer)  
