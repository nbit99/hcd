...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/nbit99/hcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/nbit99/hcd/blockchain/fullblocktests
```
