...
(http://godoc.org/github.com/nbit99/hcd/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/nbit99/hcd/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/nbit99/hcd/blockchain/chaingen
```
